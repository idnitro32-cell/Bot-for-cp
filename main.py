...
async def on_message(message: discord.Message):
    ...
    # ── Save happens via periodic auto_save_data task (every 60s)
    # We still call assign_roles and milestones immediately
